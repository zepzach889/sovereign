...
function newGame(cfg){
  ...
  S={ nation:cfg.nation, startYear, year:startYear, turn:1, era:"Dynastic", culture:cfg.culture||"anglo",
    ...
    house:cfg.house, monarch:null, family:[], lineage:[],
    ...
    eraIdx:0, knowledge:0, advances:[], works:[], _know:{}, _advDiscount:1, _newActs:[], _prevActs:[],
  ...
  for(let i=0;i<sibCount;i++){
    ...
    S.family.push(makePerson(S,"sibling",sg,sage));
  }
  S.deathRolled=false;
