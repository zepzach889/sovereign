...
function wire(){
  ...
  document.querySelectorAll("[data-seekmatch]").forEach(b=>b.onclick=()=>{S.dyn={kind:"marriage"};S.phase="dynastic";render();});
  ...
  document.querySelectorAll("[data-dcrole]").forEach(b=>b.onclick=()=>doRole(b.dataset.dcrole));
