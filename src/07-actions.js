...
/* =====================================================================
  ...
  { id:"arrears",label:"Pay the army's arrears",cool:2,
    hint:"the pay is months behind and every officer in the realm knows exactly how many",
    gain:"the barracks quieten — this is the single most reliable thing a state can do about a coup",
    cost:{gold:-34},requires:S=>(S.military>20)&&(S.treasury>-20),
    resolve:S=>({cost:{gold:-34,stability:+4},fac:{officers:+14},
      effect:S2=>{ bumpPressure(S2,"military",-22); S2._militaryLeaned=Math.max(0,(S2._militaryLeaned||0)-2); },
      chron:S2=>`the arrears were found and paid in full and in public; the whispering in the barracks stopped.`,
      out:"Paid, in coin, in front of the regiments. Unglamorous, expensive, and the most reliable thing any state has ever done about the possibility of a coup — armies do not generally overthrow governments that pay them."})},
  { id:"commission",label:"Commission from outside the great houses",cool:4,
    hint:"open the officer list to men who can do the work rather than men whose fathers could",
    gain:"an officer corps that owes its career to the state instead of to its cousins",
    cost:{gold:-18},requires:S=>eraIdx(S)>=2&&S.military>25,
    resolve:S=>({cost:{gold:-18,stability:-2},fac:{officers:+7,merchants:+7,aristocracy:-10},
      effect:S2=>{ bumpPressure(S2,"military",-14); bumpPressure(S2,"restorationist",8); },
      chron:S2=>`commissions were opened beyond the great houses, and the officer corps began to belong to the state.`,
      out:"The lists open. Able men without land start climbing, the great houses are insulted in a way they will remember, and the army's loyalty quietly detaches from the families and attaches to whoever pays and promotes it. Which, for now, is you."})},
  { id:"relief",label:"Open the granaries and fund relief",cool:2,
    hint:"grain from the public store, work for the idle, and a rate levied to pay for it",
    gain:"the streets empty — hunger is the whole of most risings",
    cost:{gold:-26},requires:S=>S.facs.peasantry.mood<62||((S.facs.workers||{}).present&&S.facs.workers.mood<62),
    resolve:S=>({cost:{gold:-26,stability:+5},fac:{peasantry:+11,workers:+9,merchants:-4},
      effect:S2=>{ bumpPressure(S2,"radical",-20); },
      chron:S2=>`the granaries were opened and relief funded at the public charge; the winter passed without a rising.`,
      out:"Bread, and work for those who want it. The merchants grumble about the rate. Every rising in history was hungry first and political second, and this is the cheap end of the problem."})},
  { id:"honours",label:"Endow the old order",cool:3,
    hint:"titles, endowments, a chapel restored, precedence confirmed at court",
    gain:"the great houses and the church remember why they liked you",
    cost:{gold:-20},requires:S=>isMonarchy(S)||eraIdx(S)<=4,
    resolve:S=>({cost:{gold:-20},fac:{aristocracy:+11,clergy:+9,merchants:-4,reformers:-5},
      effect:S2=>{ bumpPressure(S2,"restorationist",-18); },
      chron:S2=>`titles were granted, chapels endowed and precedence confirmed; the old order was reminded it had a friend.`,
      out:"Cheap, ceremonial and effective. The families that would otherwise be plotting a restoration spend the season arguing about seating instead."})},
