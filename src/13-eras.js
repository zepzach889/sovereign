...
const ADVANCES=[
  ...
  {id:"chancery",era:0,found:true,name:"The Chancery",dom:"fiscal",
   ...
   fac:{clergy:+5},effect:S=>{S._know.admin=(S._know.admin||0)+0.35;raiseDevelopment(S,4);},
  ...
  {id:"town_charters",era:0,name:"Charter of the Towns",dom:"fiscal",
   ...
   fac:{merchants:+10,aristocracy:-5},effect:S=>{raiseDevelopment(S,6);S.facs.merchants.strength=clamp(S.facs.merchants.strength+8);},
  ...
  {id:"deep_hull",era:1,found:true,name:"The Deep-Water Hull",dom:"fiscal",
   ...
   fac:{merchants:+7,provinces:+5},effect:S=>{raiseDevelopment(S,5);},
  ...
  {id:"new_crops",era:1,name:"The New Crops",dom:"civil",
   ...
   fac:{peasantry:+8,provinces:+4},effect:S=>{raiseDevelopment(S,8);S._famineEase=true;},
  ...
  {id:"post_roads",era:3,name:"The Post Roads",dom:"civil",
   ...
   fac:{merchants:+6,provinces:+8},effect:S=>{raiseDevelopment(S,7);},
  ...
  {id:"inoculation",era:4,name:"Inoculation",dom:"civil",
   ...
   fac:{clergy:-7,peasantry:+7},effect:S=>{S._mortalityEase=(S._mortalityEase||0)+0.35;raiseDevelopment(S,5);},
...
const LATE_ADVANCES=[
  {id:"engine",era:5,found:true,name:"The Engine",dom:"fiscal",
   ...
   effect:S=>{raiseDevelopment(S,10);S._know.admin=(S._know.admin||0)+0.6;S._upkeepAge=(S._upkeepAge||0)+3;},
  ...
  {id:"canals",era:5,found:true,name:"The Canal Network",dom:"civil",
   ...
   effect:S=>{raiseDevelopment(S,8);provinces(S).forEach(p=>{p.loyalty=clamp(p.loyalty+5);});S._upkeepAge=(S._upkeepAge||0)+2;},
  ...
  {id:"manufactory",era:5,name:"The Manufactory",dom:"fiscal",
   ...
   effect:S=>{raiseDevelopment(S,7);if(S.facs.workers)S.facs.workers.strength=clamp(S.facs.workers.strength+14);},
  ...
  {id:"loom",era:5,name:"The Mechanical Loom",dom:"fiscal",
   ...
   effect:S=>{raiseDevelopment(S,6);bumpPressure(S,"radical",12);},
  ...
  {id:"furnace",era:6,found:true,name:"The Furnace Works",dom:"fiscal",
   ...
   effect:S=>{raiseDevelopment(S,12);S._upkeepAge=(S._upkeepAge||0)+4;
  ...
  {id:"trunkline",era:6,found:true,name:"The Trunk Line",dom:"civil",
   ...
   effect:S=>{raiseDevelopment(S,9);provinces(S).forEach(p=>{p.loyalty=clamp(p.loyalty+8);});S._upkeepAge=(S._upkeepAge||0)+5;},
  ...
  {id:"sanitary",era:7,name:"The Sanitary Board",dom:"civil",
   ...
   effect:S=>{S._mortalityEase=(S._mortalityEase||0)+0.3;raiseDevelopment(S,8);S.stability=clamp(S.stability+6);S._upkeepAge=(S._upkeepAge||0)+5;},
